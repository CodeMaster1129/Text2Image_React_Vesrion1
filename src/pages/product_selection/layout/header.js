...
const Header = () => {
  ...
  return (
    <>
      <div className="bg-[#fbf7f2] flex justify-end items-center py-4 px-8 text-black w-full selection:select-none z-30">
        <div className="flex flex-row w-3/5 justify-between items-center">
          <div className="text-[#053536] font-bold justify-center">Home</div>
          <div className="text-[#485D5E]">Benefits</div>
          <div className="text-[#485D5E]">Pricing</div>
          <div className="text-[#485D5E]">Contact</div>
