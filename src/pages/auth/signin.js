...
const Signin = () => {
    ...
    return (
        <div className='w-[100%] h-[100%] flex flex-col items-center'>
            <div className='w-[100%] flex-grow justify-center items-center'>
                    ...
                    {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
                        <form noValidate onSubmit={handleSubmit} className='h-full'>
                            <div className='w-[100%] h-[100%] flex justify-center items-center'>
                                <div className='w-[25%] min-w-[400px] border-2 shadow-md bg-white rounded-lg px-10 py-10'>
                                    ...
                                    <div className='flex justify-center border relative'>
                                        <span className='text-black absolute -translate-y-1/2 bg-white px-4 text-sm'>Login with</span>
                                    </div>
                                    <div className='mt-8'>
